#ifndef __VLOAD_CONTROL_H__
#define __VLOAD_CONTROL_H__

#include <libvapi/vthread.h>
//#include "ycgroups_internal.h"
...
struct vcategory {
    int priority;
    int policy;
    struct ycgroup cgroups[NB_CGROUP_CONTROLLERS];
};
 ...
 *          YLOAD_CATEGORY_INVALID is returned
 *
 ...
 *          YLOAD_CATEGORY_COUNT in case of success.
 */
